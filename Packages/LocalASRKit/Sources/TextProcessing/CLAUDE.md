<!-- Generated from Packages/LocalASRKit/Sources/TextProcessing/AGENTS.md by Scripts/sync_claude_md.py. Do not edit. -->
<!-- Claude Code reads CLAUDE.md; AGENTS.md stays the source of truth. -->
<!-- After editing Packages/LocalASRKit/Sources/TextProcessing/AGENTS.md, rerun: python3 Scripts/sync_claude_md.py -->
