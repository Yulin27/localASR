...
- `AGENTS.md` is the source of truth for every guide. Each one is mirrored to a
  generated `CLAUDE.md` beside it, because Claude Code loads `CLAUDE.md` only.
  After editing any `AGENTS.md`, run `python3 Scripts/sync_claude_md.py`.
